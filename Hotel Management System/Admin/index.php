		...
		<div id="banner"><br><br><br><br><br><br><br><br><br><br><br>
	       ...
	       <table>
	       	<tr>
	       		...
	       		<td width="50%" height="50px"><input type="password" name="ps" placeholder="Enter Password" title="Enter Password" required></td>
	       	</tr>
	       	<tr>
	       		<td colspan="2"><input type="submit" name="sub" value="Login" style="width: 150px; margin-left: 180px; height: 50px;border-radius: 30px;opacity: 0.8"></td>
	       	</tr>
	       </table>
	       </form>
	       <?php
