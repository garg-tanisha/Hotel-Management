	...
	<div id="full">
		...
		<div id="banner"><br><br><br><br><br><br><br><br><br><br>
			<center><div style="background:rgba(255,255,255,.5); width: 80%;height: 400px;">
				<a href="contact.php"><h2 align="left" style="color: red;padding: 10px;s">CONTACT INFORMATION</h2></a>
               ...
               <a href="contact.php"><h2 align="left" style="color: red;padding: 10px;s"> PROVIDE YOUR VALUABLE FEEDBACK</h2></a>
