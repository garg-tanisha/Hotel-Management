...
<div id="banner"><br>
	       ...
	       <table>
	       	<tr>
	       		...
	       		<td width="50%" height="50px"><input type="text" class="inp" name="name" placeholder="Enter Username" title="Enter Username"></td>
	       	</tr>
	       	<tr>
	       		<td width="50%" height="50px">Email</td>
	       		<td width="50%" height="50px"><input type="text" class="inp"name="email" placeholder="Enter your email" title="Enter email"></td>
	       	</tr>
	       		<tr>
	       		<td width="50%" height="50px">Contact Number</td>
	       		<td width="50%" height="50px"><input type="text" class="inp"name="phone" placeholder="Enter your Contact Number" title="Enter contact"></td>
	       	</tr>
	       		<tr>
	       		<td width="50%" height="50px">Message</td>
	       		<td width="50%" height="50px"><input type="text" class="inp" id="msg-box" name="msg" placeholder="Enter your message here" title="Enter message"></td>
	       	</tr>
